    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
        <div className="flex justify-between items-center p-4 border-b">
          <h2 className="text-xl font-bold text-right">إتمام عملية الدفع</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <Button 
            type="submit" 
            className="w-full bg-growup hover:bg-growup-dark h-14 text-lg font-semibold"
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="bg-white px-3 text-sm text-gray-500 absolute">أو الدفع باستخدام</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <button 
              ...
              className="bg-gray-100 hover:bg-gray-200 rounded-lg p-3 flex justify-center items-center transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 210.2" xmlSpace="preserve" width="70">
            ...
            <button 
              ...
              className="bg-gray-100 hover:bg-gray-200 rounded-lg p-3 flex justify-center items-center transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="70" viewBox="0 0 576 512" fill="#283593">
                <path d="M492.4 220.8c-8.9 0-16.4-1.8-24.5-8.2v57c8.1 5.1 16.4 10.1 24.5 10.1 18.6 0 32.7-12.2 32.7-30.5-.1-17.9-13.7-28.4-32.7-28.4zm-82 55.9h-30.8l-11.5 11.3v-35.6l11.5 11.3h30.8c6.3 0 13 2.6 13 11.5 0 8.9-6.7 11.5-13 11.5zm-321.5 63.8L72.9 213.1h16.7l15 24.
                2h2V213h14.3v65.9h-14.3v-26.6h-2l-16 26.6H72.9v.1zm58.1 0H115V213h14.3z" />
                <path d="M350.6 236c0 8.3-6.9 15.1-15.3 15.1h-20.6v28.9h-14.3V213h34.9c8.4 0 15.3 6.8 15.3 15.1zm145.8 37.9c0 3-.6 5.9-1.7 8.7-4.2 10.4-15.3 17.4-26.9 17.4-14.8 0-26.9-10.1-26.9-24.9s12.1-24.9 26.9-24.9c6.9 0 13.6 2.7 18.5 7.9l.4.4-8.1 7.8-.4-.4c-2.5-2.4-5.8-3.7-9.1-3.6-6.5 0-11.5 3.6-13.1 11.5 1.8-2.2 8.2-3.4 12.3-3.4.5 0 1 0 1.6.1 9.7.9 15.8 8.4 15.8 17.7 0 .4-.2.5-.3 1.3h-4.7c.3-5-3.6-9.2-8.6-9.2-4.8 0-8.7 3.9-8.7 8.7s3.9 8.7 8.7 8.7c3.2 0 6.3-1.8 7.7-4.7H458v-5h37.8c.5 0 .6 0 .6.5zM202.5 276.9h-14.3V213h14.3v63.9zm-25.5 0h-32v-14.3h32v14.3z" />
              </svg>
            </button>
          </div>
        </form>
