...
import { InstallmentCalculator } from './InstallmentCalculator.tsx';
  ...
  return (
    <div className="min-w-[320px] w-[320px]">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-[20px] font-bold font-cairo">الالتزامات الشهرية</h1>
        <Button
...
/>
      ...
      />
                  <InstallmentCalculator onAddObligation={addObligation} />
