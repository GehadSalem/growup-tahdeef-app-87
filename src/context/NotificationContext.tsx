...
import { NotificationService, Notification as BaseNotification } from '@/services/notificationService';

interface Notification extends BaseNotification {
  actionType?: string;
  read: boolean; // Ensure 'read' property exists
}
...
export const NotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Ensure every notification has a 'read' property
